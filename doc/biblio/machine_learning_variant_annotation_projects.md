...
The following paper was used to complete the informations, we strongly recommend to read the part I. and II., that provides a complete overview of the topic before 2016:  
...
* Algorithm:
	* Random forest
* Features:
	* SIFT, Pfam-based LogR.E-value and GOSS
* Dataset:
...
* Other:
	* One of the first machine learning algorithm techniques designed especially to dicsriminate driver from passenger mutations in cancer.
...
## MutationAssessor
**Website:** http://mutationassessor.org/r3/  
...
* Features:
	* Combines sequence-based conservation features (the alignement of homologous sequences and conserved protein domains) and pathogenicity weights (indicative of the overall tolerance of the protein model to mutations)
...
* Other:
	...
	* Performed various existing and independent benchmarking:
		* VariBench: 40,740 AAs -> perform an existing benchmarking
		* Hicks et al.2011: 267 AAs -> perform an existing benchmarking
		* SwissVar: 59,976 AAs -> perform an independent benckmarking
...
* Features:
	...
	* See article for details on feature selection:
		* For GBM: 21 final features
		* For OVC: 22 final features
	* Features with missing values estimated with k-nearest neighbors algorithm
* Dataset:
